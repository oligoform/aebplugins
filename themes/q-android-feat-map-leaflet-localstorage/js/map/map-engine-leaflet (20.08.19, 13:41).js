            ...
            if (!this.isMapActive() && $('#' + this.get('id')).length) {
                ...
                fetch(url).then(response => {
                    ...
                    flattenedArray.forEach(function (entry, index) {
                        ...
                        let popupContent = `<div id='${location_id}'>${theTitle} <br /> ${location_address} <br /> ${location_postcode}${location_region}${barrierefrei}${email}${telefonnummer} <br>${frei} </div>`; //olg test 20190815
                        ...
                        $(".readmore").click(function (event) {
                            ...
                            locationsCached.forEach(function (entry, index) {
                                ...
                                if (arrayId == getId) {
                                    ...
                                    let email = entry[arrayId].email !== "" ? 'E-Mail: ' + entry[arrayId].email + '<br/>' : '';
