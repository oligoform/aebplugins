    ...
    return Backbone.Model.extend({
        ...
        initMap: function () {
            if (!this.isMapActive() && $('#' + this.get('id')).length) {
                ...
                let getStoredData = JSON.parse(window.localStorage.getItem("indexArray"));
...
//indeez Array in Storage
                            indexArray = JSON.stringify(indexArray)

                            window.localStorage.setItem('indexArray', indexArray);
                            ...
                            flattenedArray.forEach((entry, index) => {
                                ...
                                window.localStorage.setItem('aEntry_' + arrayId, singleInformation);
                            });
                ...
                promiseData.then(data => {
                    ...
                    window.localStorage.setItem("geoJsonData", geojsonFeature);
                    ...
                    mcg.on('popupopen', function (popup) {
                        ...
                        $(".readmore").click(function (event) {
                            ...
                            var locationsCached = JSON.parse(window.localStorage.getItem("aEntry_" + $(this).data('id')));
