...
/**
     ...
     */
     $imagereplacementsvg = '<svg xmlns="http://www.w3.org/2000/svg" width="912" height="816"><path d="M200 200v416h512V200H200zm480 384H232V232h448v352zM552 312c0 26.51 21.49 48 48 48s48-21.49 48-48-21.49-48-48-48-48 21.49-48 48zm96 240H264l96-256 128 160 64-48 96 144z" fill="#057d9a" fill-opacity="0.31674209"/></svg>';
    window.displayDefaultImage = function(o) {
        $(o).attr('src',$imagereplacementsvg);
    }
